...
Original file is located at
    https://colab.research.google.com/drive/18pSTkm4BrC1ur4OqSymVCXkDopCIBGG2
"""
...
import gradio as gr
import torch
from transformers import AutoTokenizer, AutoModelForCausalLM # Corrected model import
import PyPDF2 # Corrected import
import io
...
model=AutoModelForCausalLM.from_pretrained(
    model_name,
    torch_dtype=torch.float16 if torch.cuda.is_available() else torch.float32, # Corrected dtype
...
def generate_response(prompt,max_length=1024):
  ...
  with torch.no_grad():
    ...
    response=response.replace(prompt,"").strip() # Corrected replace call
    return response
